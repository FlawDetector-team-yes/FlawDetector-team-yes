...
// //me/detected 검사 완료된 아이템요소 컴포넌트
export default function DetectedListItem() {
  // 배열을 생성, 길이는 22
          ...
          .map((item, index) => (
            ...
            >
              <div className="relative flex h-[30px] justify-between">
                <div className="h-[23px] w-[43px] rounded-full border border-solid border-[#A66FFF] bg-[#FAF8FF] px-1 py-[2px] text-center text-[12px] text-[#6100FF]">
                  label
                </div>
                <div
