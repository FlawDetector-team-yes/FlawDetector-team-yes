  ...
  return (
    <div className="mx-auto mb-[70px] flex w-[65vw] flex-col gap-[20px]">
      ...
      <div className="border-b border-stroke-10 pb-10">
        <div className="flex flex-col gap-1 indent-5 text-sm">
          <pre>1. 개인정보의 수집 및 이용 목적, 항목 및 수집방법</pre>
          <pre>2. 개인정보의 제공 및 처리위탁</pre>
          <pre>3. 개인정보 수집·이용의 거부 시 불이익</pre>
          <pre>4. 개인정보 보유 및 이용기간</pre>
          <pre>5. 개인정보의 파기절차 및 방법</pre>
          <pre>6. 회원의 권리와 행사 방법</pre>
          <pre>7. 개인정보 자동 수집 장치의 설치/운영 및 거부에 관한 사항</pre>
          <pre>8. 개인정보 보호를 위한 기술적/관리적 대책</pre>
          <pre>9. 개인정보 관리 책임자의 성명, 연락처, 부서</pre>
          <pre>10. 권익침해 구제방법</pre>
          <pre>11. 고지의 의무</pre>
        </div>
      </div>
      <div className="flex flex-col gap-5 border-b border-stroke-10 pb-10 pt-5 text-sm">
        ...
        <div className="flex flex-col gap-1 indent-5">
          <pre>
            1. &rdquo개인정보&rdquo란 생존하는 개인에 관한 정보로서 당해 개인을
            식별할 수 있는 정보를 말합니다.
          </pre>
          <pre>
            2. &rdquo회사&rdquo는 수집된 개인정보를 다음의 목적을 위해
            활용합니다.
          </pre>
        </div>
        <div className="flex flex-col gap-1 indent-10">
          <pre>
            a. 회원가입 및 의사소통에 관한 사항: 회원 본인확인, 부정 가입방지,
            가입 의사확인, 고충상담 및 처리, 불만처리 등 민원처리 등
          </pre>
          <pre>b. 서비스 제공에 관한 사항: 코드 검사 서비스 제공</pre>
          <pre>
      ...
      <div className="flex flex-col gap-5 pt-5 text-sm">
        ...
        <div className="flex flex-col gap-5 border-b border-stroke-10 pb-10">
          ...
          <div className="flex flex-col gap-1 indent-5">
            ...
            <pre>3. 대검찰청 : (국번없이) 1301 (www.spo.go.kr)</pre>
            <pre>4. 경찰청 : (국번없이) 182 (ecrm.cyber.go.kr)</pre>
          </div>
        </div>
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <pre>
              회사는 개인정보처리방침이 변경되는 경우에는 &rdquo회사&rdquo의
              사이트 &rdquo공지사항&rdquo을 통하여 변경 및 시행의 시기, 변경
              내용을 공지합니다.
            </pre>
            <pre>
